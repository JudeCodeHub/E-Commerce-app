...
export default function Banner() {
    ...
    return isOpen && (
        <div className="w-full px-6 py-1 font-medium text-sm text-white text-center bg-gradient-to-r from-[#fbbd0c] via-[#ff0000] to-[#1876ff]">
            <div className='flex items-center justify-between max-w-[1600px]  mx-auto'>
                <p>Get 20% OFF on Your First Order!</p>
                <div className="flex items-center space-x-6">
                    <button onClick={handleClaim} type="button" className="font-normal text-gray-800 bg-white hover:bg-[#1876ff] hover:text-white transition px-7 py-2 rounded-full max-sm:hidden">Claim Offer</button>
