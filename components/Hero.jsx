            ...
            <div className='flex max-xl:flex-col gap-8 max-w-[1600px] mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-[#fbbd0c] rounded-3xl xl:min-h-100 group overflow-hidden'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-amber-100 text-amber-700 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-amber-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free Shipping on Orders Above $50! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                        <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-slate-700 to-[#FFF4C0] bg-clip-text text-transparent max-w-xs  sm:max-w-md'>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    ...
                    <div className='relative flex-1 flex items-center justify-between w-full h-36 bg-[#1876ff] rounded-3xl p-6 px-8 group'>
                        ...
                        <Image className='absolute -right-8 top-1/2 -translate-y-[50%] w-80 group-hover:scale-105 transition duration-300' src={assets.hero_product_img2} alt="" />
                    </div>
                </div>
            </div>
            <CategoriesMarquee />
